...
keyword2title = {
    ...
    'mutepithelium': "Proportion mutated epithelium",
    'ageevent': 'Age at genomicevent',
    ...
    # mutated epithelium
    'meanexcess': 'drivers mean',
    'lowciexcess': 'drivers low CI',
    'highciexcess': 'drivers high CI',
    'total': 'total',
    'am': 'all molecules',
    'mg': 'mutated haploid genomes',
    'me': 'mutated epithelium',
