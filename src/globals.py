...
from src.regressions.models import MODELS
from src.regressions.schema import *
...
CONFIG_TEMPLATE_GENERAL = {
    ...
    "predictors_intercept_0": ["predictors for which to force intercept at 0 (leave empty if NA)", ""],
...
CONFIG_TEMPLATE_PLOT = {
    "predictors_names": ["add names for your predictors (same order as above) (leave empty if NA)", ""],
    "predictors_colors": ["add color codes for your predictors (same order as above) (leave empty if NA)", ""],
}
