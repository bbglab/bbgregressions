...
- `variables`: this field contains information about several variables used in the analysis. 
    ...
    + `predictors_file`: path to the file containing the per sample values of the predictors you want to include in the analysis (usually your metadata table). **Note**: currently the pipeline only admits continuous or binary categorical variables as predictors. If you are using the latter, please codify them as 0 or 1 (0 indicates this is the baseline effect of this variable).
